...
echo "How To Change SSH Port"

nano /etc/ssh/sshd_config

CTRL \ (make sure its the right SLASH)
...
#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   _____                                        _____       _           
  / ____|                                      |  __ \     | |          
 | |     ___  _ __ ___  _ __ ___   ___  _ __   | |__) |   _| | ___  ___ 
 | |    / _ \| '_ ` _ \| '_ ` _ \ / _ \| '_ \  |  _  / | | | |/ _ \/ __|
 | |___| (_) | | | | | | | | | | | (_) | | | | | | \ \ |_| | |  __/\__ \
  \_____\___/|_| |_| |_|_| |_| |_|\___/|_| |_| |_|  \_\__,_|_|\___||___/

#/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

echo "Flush All In Coming Traffic"
...
type "w" to see everyone on the server 

#//////////////////////////

echo "Capture Attacks"
...
echo "Checking Current Iptables"
...
echo "Applying Basic Dos / DDos Filters"
iptables -A INPUT -s 73.144.69.72 -j DROP
...
echp "Block All Packets From IP's Ending In .0.0
